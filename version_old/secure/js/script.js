...
$("ul#otherCards li").on("click", function()
{
	...
	else
	{
		...
		if(isIE11 || iOS){
			var content = "<div class='videoWrapper'><iframe src='https://www.youtube.com/embed/fUB7oLawfDc?rel=0&amp;showinfo=0&amp;loop=1&amp;autoplay=1' frameborder='0' allowfullscreen></iframe></div>";
		} else {
...
$(document).on("click", "#sendConfirmation li#send a", function(e)
{
	...
	var progressComplete = "<div id='cardProgressCompleted'>" +
								...
								"<a href='reset.php'>Nog een kaart versturen</a>" +
							"</div>";
