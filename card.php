			    ...
			    <div id="cardCon">
			    	...
			    	<?php 
			    		if($cardInfo['card_type'] == "animated")
						{
							...
							if(preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false)){
								echo "<div class='videoWrapper'><iframe src='https://www.youtube.com/embed/vAZT4TcoQ1I?&amp;wmode=transparent&amp;rel=0&amp;showinfo=0&amp;loop=1&amp;autoplay=1&amp;playlist=vAZT4TcoQ1I' frameborder='0' allowfullscreen></iframe>
								...
								echo "<div class='videoWrapper'><iframe src='https://www.youtube.com/embed/vAZT4TcoQ1I?&amp;wmode=transparent&amp;rel=0&amp;showinfo=0&amp;loop=1&amp;autoplay=0&amp;playlist=vAZT4TcoQ1I' frameborder='0' allowfullscreen></iframe>
											</div><img style='visibility: hidden;width: 0;height: 0;' src='img/full_kaart_1.png' data-id='1' alt='Geanimeerde kerstkaart' data-type='animated'></img>";
							} else {
